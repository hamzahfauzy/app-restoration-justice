        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Terima <?=_ucwords(__($table))?> : <?=$data->title??''?></h2>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <select name="case_schedules[status]" id="" class="form-control">
                                        <option value="accepted">Di terima</option>
                                        <option value="rejected">Di tolak</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="">Alasan</label>
                                    <textarea name="case_schedules[reason]" class="form-control"></textarea>
                                </div>
                                <div class="form-group">

                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="case_contacts[reporter]" class="form-control" value="<?= $old['wa_reporter'] ?? '' ?>">
                                </div>
                                <div class="form-group">
                                    <label for="">No WA Terlapor (62xxx)</label>
                                    <input type="number" name="case_contacts[reported]" class="form-control" value="<?= $old['wa_reported'] ?? '' ?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Nama Penyidik</label>
                                    <input type="text" name="case_contacts[investigator][name]" class="form-control" value="<?= $old['investigator_name'] ?? '' ?>">
                                </div>
                                <div class="form-group">
                                    <label for="">No WA Penyidik (62xxx)</label>
                                    <input type="number" name="case_contacts[investigator][phone]" class="form-control" value="<?= $old['investigator_phone'] ?? '' ?>">
                                </div>
                                <div class="form-group">
